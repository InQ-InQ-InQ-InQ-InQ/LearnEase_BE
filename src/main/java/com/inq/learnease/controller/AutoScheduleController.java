...
public class AutoScheduleController {
    ...
    public ResponseEntity<List<Task>> makeAutoSchedule(@AuthenticationPrincipal final LoginRequest loginRequest, AutoScheduleRequestDto autoScheduleRequestDto) {
